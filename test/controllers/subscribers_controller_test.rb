...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post subscribers_url, params: { subscriber: { apellidos: @subscriber.apellidos, correo: @subscriber.correo, nombres: @subscriber.nombres, preferencias: @subscriber.preferencias } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { apellidos: @subscriber.apellidos, correo: @subscriber.correo, nombres: @subscriber.nombres, preferencias: @subscriber.preferencias } }
